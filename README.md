...
* You will create your store in `src/index.js`. The `<Provider >` component will wrap `<TodoList />` and you will pass the created store into `<Provider >` as one of its properties. Use [this](https://github.com/SunJieMing/redux-example-movies) repository as a reference.
